        ...
        $('body').waitForImages({
            finished: function() {
                ...
                setTimeout(function() {
                    ...
                    $('body').waitForImages({
                        finished: function() {
                            TweenMax.to($("#header-container, #footer-container"), 1, {
                                force3D: true,
                                opacity: 1,
                                ease: Power2.easeOut
                            });
                            TweenMax.to($(".split-slider #image-slider"), 1.2, {
                                force3D: true,
                                opacity: 0.8,
                                x: 0,
                                scale: 1,
                            ...
                            TweenMax.to($(".centered-slider #image-slider"), 1, {
                                force3D: true,
                                opacity: 0.8,
                                x: 0,
                                scale: 0.6,
                            ...
                            TweenMax.to($("#external-caption"), 0.6, {
                                force3D: true,
                                opacity: 1,
                                delay: 1,
                                x: 0,
                            ...
                            TweenMax.to($(".centered-slider .swiper-slide-active"), 1, {
                                force3D: true,
                                scale: 1,
                                opacity: 1,
                                delay: 0.8,
                            ...
                            TweenMax.to($(".centered-slider .swiper-slide-active").prev(), 1, {
                                force3D: true,
                                scale: 1,
                                opacity: 1,
                                delay: 0.85,
                            ...
                            TweenMax.to($(".centered-slider .swiper-slide-active").next(), 1, {
                                force3D: true,
                                scale: 1,
                                opacity: 1,
                                delay: 0.85,
                            ...
                            TweenMax.to($(".centered-slider .swiper-slide-active").prev().prev(), 1, {
                                force3D: true,
                                scale: 1,
                                opacity: 1,
                                delay: 0.9,
                            ...
                            TweenMax.to($(".centered-slider .swiper-slide-active").next().next(), 1, {
                                force3D: true,
                                scale: 1,
                                opacity: 1,
                                delay: 0.9,
                            ...
                            TweenMax.to($(".centered-slider .swiper-slide"), 1, {
                                force3D: true,
                                scale: 1,
                                opacity: 1,
                                delay: 1,
...
function FirstLoad() {
    ...
    $('a.ajax-link').on('click', function() {
        ...
        if ($('#showcase-holder').length > 0) {
            TweenMax.to($(".split-slider .image-slider-wrapper"), 0.4, {
                force3D: true,
                xPercent: -10,
                delay: 0.2,
                opacity: 0,
            ...
            TweenMax.to($(".split-slider .swiper-slide-active"), 0.4, {
                force3D: true,
                x: -250,
                opacity: 0,
                delay: 0,
            ...
            TweenMax.to($(".split-slider .swiper-slide-active").next(), 0.4, {
                force3D: true,
                x: -250,
                opacity: 0,
                delay: 0.05,
            ...
            TweenMax.to($(".split-slider .swiper-slide-active").next().next(), 0.4, {
                force3D: true,
                x: -250,
                opacity: 0,
                delay: 0.1,
            ...
            TweenMax.to($(".split-slider .swiper-slide-active").next().next().next(), 0.4, {
                force3D: true,
                x: -250,
                opacity: 0,
                delay: 0.15,
            ...
            TweenMax.to($(".split-slider .swiper-slide-active").next().next().next().next(), 0.4, {
                force3D: true,
                x: -250,
                opacity: 0,
                delay: 0.2,
            ...
            TweenMax.to($(".centered-slider #image-slider"), 0.4, {
                force3D: true,
                opacity: 0,
                x: 0,
                scale: 0.3,
        ...
        TweenMax.to($("#footer-container,#external-caption"), 0.3, {
            opacity: 0,
            ease: Power0.ease
        });
    });
...
function LazyLoad() {
    ...
    $('body').waitForImages({
        finished: function() {
            ...
            TweenMax.to($("#external-caption"), 0.7, {
                force3D: true,
                opacity: 1,
                delay: 0.7,
                x: 0,
        ...
        if ($('#hero').hasClass("has-image")) {
            ...
            function HeroParallaxScroll() {
                ...
                if ($('#hero-styles').hasClass("parallax-onscroll")) {
                    TweenMax.to(HeroCaption, 0.1, {
                        y: windowScrolled / 4
                    });
                    TweenMax.to(HeroImage, 0.1, {
                        y: windowScrolled / 5
                    });
                }
